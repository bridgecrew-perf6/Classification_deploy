...
def predict_label(Rating,Total_Reviews,SME_Data,Distance,Check_Web,Check_Telepon):
    input=np.array([[Rating, Total_Reviews, SME_Data, Distance, Check_Web, Check_Telepon]]).astype(np.float64)
...
def main():
    ...
    if st.button("Predict"):
        output=predict_label(Rating,Total_Reviews,SME_Data,Distance,Check_Web,Check_Telepon)
